        ...
        <table id="zero_config" class="table table-inverse table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {!! Form::open(['method' => 'DELETE', 'route' => ['admin.lecturers.destroy', $item->id], 'onsubmit' => "return confirm('آیا برای حذف مطمئن هستید؟');"]) !!}
                        <a href="{{ route('admin.lecturers.edit', $item->id) }}" class="btn btn-primary">
