...
@section('main')
    <div class="text-right">
        <a href="{{ route('admin.ashnaee.create') }}" class="btn btn-success">
            افزودن
        </a>
    </div>
    <br>
        ...
        <table id="zero_config" class="table table-inverse table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {!! Form::open(['method' => 'DELETE', 'route' => ['admin.ashnaee.destroy', $item->id], 'onsubmit' => "return confirm('آیا برای حذف مطمئن هستید؟');"]) !!}
                        <!-- <a href="{{ route('admin.doreha.show', ['id' => $item->id, 'title' => str_replace(" ", "-", $item->title)]) }}" class="btn btn-dark" target="_blank">
                            <i class="fa fa-eye"></i>
                        </a> -->
                        <a href="{{ route('admin.ashnaee.edit', $item->id) }}" class="btn btn-primary">
