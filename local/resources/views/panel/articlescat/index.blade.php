...
@section('main')
    <div class="text-right">
        <a href="{{ route('admin.articlescat.create') }}" class="btn btn-success">
            افزودن
        </a>
        ...
        <table id="zero_config" class="table table-inverse table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {!! Form::open(['method' => 'DELETE', 'route' => ['admin.articlescat.destroy', $item->id], 'onsubmit' => "return confirm('آیا برای حذف مطمئن هستید؟');"]) !!}
                        <a href="{{ route('site.articles.category', $item->slug) }}" class="btn btn-dark" target="_blank">
                            <i class="fa fa-eye"></i>
                        </a>
                        <a href="{{ route('admin.articlescat.edit', $item->id) }}" class="btn btn-primary">
