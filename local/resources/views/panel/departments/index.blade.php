        ...
        <table id="zero_config" class="table table-inverse table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {!! Form::open(['method' => 'DELETE', 'route' => ['admin.departments.destroy', $item->id], 'onsubmit' => "return confirm('آیا برای حذف مطمئن هستید؟');"]) !!}
                        <a href="{{ route('site.courses.department', $item->slug) }}" class="btn btn-dark" target="_blank">
                            <i class="fa fa-eye"></i>
                        </a>
                        <a href="{{ route('admin.departments.edit', $item->id) }}" class="btn btn-primary">
