    ...
    <main class="downloads">
        ...
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('site.downloads.category', $downloadCat->slug) }}">
                        {{ $downloadCat->title }}
                    </a>
                </li>
            </ul>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1 class="title">
                        <span>دسته بندی</span> {{ $downloadCat->title }}
                    </h1>
...
@endsection
@section('seo')
<meta name="description" content="{{ $downloadCat->title }} - {{ Seo::desc('default') }}">
<meta name="keywords" content="{{ $downloadCat->title }}, {{ Seo::key('default') }}">
<meta property="og:description" content="{{ $downloadCat->title }} - {{ Seo::desc('default') }}">
