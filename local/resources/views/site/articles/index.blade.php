...
@endsection
@section('seo')
<meta name="description" content="{{ Seo::desc('articles') }}">
<meta name="keywords" content="{{ Seo::key('articles') }}">
<meta property="og:description" content="{{ Seo::desc('articles') }}">
<meta property="og:image" content="{{ Seo::image('articles') }}">
@endsection